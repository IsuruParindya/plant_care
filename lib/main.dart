...
void main() async {
  ...
  // Load saved user data (or default empty values)
...
class UserData extends ChangeNotifier {
  ...
  /// Update user data and save immediately
  void update({
    String? username,
    String? email,
    String? password,
  ...
  ImageProvider<Object>? get avatarImage {
    ...
    return null; // fallback: show default avatar in UI
  }
}
